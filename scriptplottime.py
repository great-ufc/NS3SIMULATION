...
try:
	with open('resultados10.txt', 'r') as arquivo:				
		for linha in arquivo:
			y1.append(float(linha.split(" - ")[1].split(";")[0].split(": ")[1]))
			mean = mean + float(linha.split(" - ")[1].split(";")[0].split(": ")[1])
			x1.append(i)
			i=i+1
except IOError:		
	pass
...
try:
	with open('resultados50.txt', 'r') as arquivo:				
		for linha in arquivo:
			y2.append(float(linha.split(" - ")[1].split(";")[0].split(": ")[1]))
			mean = mean + float(linha.split(" - ")[1].split(";")[0].split(": ")[1])
			x2.append(i)
			i=i+1
except IOError:		
...
try:
	with open('resultados100.txt', 'r') as arquivo:				
		for linha in arquivo:
			y3.append(float(linha.split(" - ")[1].split(";")[0].split(": ")[1]))
			mean = mean + float(linha.split(" - ")[1].split(";")[0].split(": ")[1])
			x3.append(i)
			i=i+1
except IOError:		
...
try:
	with open('resultados250.txt', 'r') as arquivo:				
		for linha in arquivo:
			y4.append(float(linha.split(" - ")[1].split(";")[0].split(": ")[1]))
			mean = mean + float(linha.split(" - ")[1].split(";")[0].split(": ")[1])
			x4.append(i)
			i=i+1
except IOError:		
...
for ax in axs.flat:
    ax.set(xlabel='nº da Simulação', ylabel='Tempo (s)')
